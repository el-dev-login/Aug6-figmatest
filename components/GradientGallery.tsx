    ...
    <div className="w-full">
      <div className="grid grid-cols-2 gap-6 max-w-4xl mx-auto p-8">
        {gradients.map((gradient) => (
          <div
            key={gradient.id}
            className="aspect-square rounded-2xl cursor-pointer overflow-hidden shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
      ...
      {selectedGradient && (
        ...
        >
          ...
          >
            ...
            {/* Content card */}
            <div className="bg-white dark:bg-gray-900 rounded-b-2xl p-8 shadow-2xl">
